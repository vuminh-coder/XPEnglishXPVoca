        ...
        <div className="p-6 sm:p-8 bg-white dark:bg-slate-900 border border-slate-200/80 dark:border-white/10 rounded-xs shadow-2xs space-y-6 text-xs sm:text-sm leading-relaxed text-slate-700 dark:text-slate-300">
          <section className="space-y-2">
            <h2 className="text-base font-bold text-slate-900 dark:text-white flex items-center gap-2 font-display">
              <span className="w-2 h-2 rounded-full bg-[#0059bb]" /> 1. Chấp Thuận Điều Khoản
            </h2>
            <p>
          ...
          <section className="space-y-2">
            <h2 className="text-base font-bold text-slate-900 dark:text-white flex items-center gap-2 font-display">
              <span className="w-2 h-2 rounded-full bg-[#0059bb]" /> 2. Tài Khoản Học Viên & Bảo Mật
            </h2>
            <p>
          ...
          <section className="space-y-2">
            <h2 className="text-base font-bold text-slate-900 dark:text-white flex items-center gap-2 font-display">
              <span className="w-2 h-2 rounded-full bg-[#0059bb]" /> 3. Quyền Sở Hữu Trí Tuệ & Nội Dung
            </h2>
            <p>
          ...
          <section className="space-y-2">
            <h2 className="text-base font-bold text-slate-900 dark:text-white flex items-center gap-2 font-display">
              <span className="w-2 h-2 rounded-full bg-[#0059bb]" /> 4. Quy Tắc Ứng Xử Cộng Đồng
            </h2>
            <p>
          ...
          <section className="space-y-2">
            <h2 className="text-base font-bold text-slate-900 dark:text-white flex items-center gap-2 font-display">
              <span className="w-2 h-2 rounded-full bg-[#0059bb]" /> 5. Liên Hệ Hỗ Trợ
            </h2>
            <p>
