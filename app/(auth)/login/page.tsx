      ...
      <header className="lg:hidden w-full px-4 sm:px-8 py-3 flex justify-between items-center bg-white/80 dark:bg-[#09090b]/80 border-b border-slate-200/80 dark:border-white/10 backdrop-blur-md sticky top-0 z-30 select-none">
        ...
        <div className="relative">
          <button
            ...
            className="h-8 px-2.5 rounded border border-slate-200/90 dark:border-white/10 bg-slate-50 dark:bg-[#18191c] hover:bg-slate-100 dark:hover:bg-slate-800 transition-all text-xs font-bold text-slate-700 dark:text-slate-200 flex items-center gap-1.5 cursor-pointer shadow-2xs"
          >
          ...
          {isLangOpen && (
            <div className="absolute right-0 mt-1 w-36 bg-white dark:bg-[#121316] border border-slate-200 dark:border-white/10 rounded shadow-lg py-1 z-50">
              <button
                type="button"
            ...
            <div className="w-full max-w-[420px] bg-white dark:bg-[#121316] border border-slate-200/90 dark:border-white/10 rounded-md sm:rounded-lg p-6 sm:p-8 shadow-md shadow-slate-200/40 dark:shadow-none relative">
              ...
              <div className="grid grid-cols-2 gap-3 mb-4">
                <button
                  ...
                  disabled={isLoading}
                  className="h-10 border border-slate-200/90 dark:border-white/10 rounded bg-slate-50 dark:bg-[#18191c] hover:bg-slate-100 dark:hover:bg-slate-800 transition-all text-xs font-bold text-slate-700 dark:text-slate-200 flex items-center justify-center gap-2 shadow-2xs disabled:opacity-50 cursor-pointer"
                >
              ...
              <form onSubmit={handleLoginSubmit} className="space-y-4">
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      placeholder="••••••••"
                      className="w-full h-10 pl-9 pr-9 rounded border border-slate-200/90 dark:border-white/10 bg-slate-50/80 dark:bg-[#18191c] text-slate-900 dark:text-white placeholder:text-slate-400 text-xs font-medium focus:border-[#0059bb] focus:bg-white dark:focus:bg-[#0c0d0e] focus:ring-2 focus:ring-[#0059bb]/20 focus:outline-none transition-all"
                      required
                    />
                    <button
                      type="button"
                ...
                <button
                  type="submit"
                  disabled={isLoading}
                  className="w-full h-10 mt-2 bg-[#0059bb] hover:bg-blue-700 active:scale-[0.99] text-white font-bold rounded text-xs shadow-sm flex items-center justify-center gap-2 transition-all disabled:opacity-50 cursor-pointer"
                >
                  {isLoading ? (
