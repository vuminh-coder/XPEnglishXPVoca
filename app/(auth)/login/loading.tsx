        ...
        <div className="w-full grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
          ...
          <div className="hidden lg:flex lg:col-span-7 flex-col items-start gap-6">
            ...
            <div className="space-y-2 w-full">
              <div className="h-6 w-44 rounded-lg bg-blue-500/20 dark:bg-blue-400/20" />
          ...
          <div className="lg:col-span-5 w-full flex justify-center items-center">
            <div className="w-full max-w-[440px] bg-white dark:bg-[#0c0c0f] border border-slate-200/90 dark:border-slate-800 rounded-2xl p-6 sm:p-8 shadow-md space-y-4">
              ...
              <div className="text-center space-y-2 mb-2">
                <div className="h-8 w-36 mx-auto rounded-xl bg-slate-300 dark:bg-slate-700" />
                <div className="h-4 w-56 mx-auto rounded-md bg-slate-100 dark:bg-slate-800/60" />
              </div>

              {/* Social Login Buttons */}
              <div className="grid grid-cols-2 gap-3">
                <div className="h-11 rounded-xl bg-slate-100 dark:bg-slate-800/40 border border-slate-200/90 dark:border-slate-800" />
                <div className="h-11 rounded-xl bg-slate-100 dark:bg-slate-800/40 border border-slate-200/90 dark:border-slate-800" />
              </div>

              {/* Divider */}
              <div className="flex items-center my-4">
                <div className="flex-1 h-px bg-slate-200/90 dark:border-slate-800" />
                <div className="h-3 w-28 mx-2 rounded-md bg-slate-100 dark:bg-slate-800" />
                <div className="flex-1 h-px bg-slate-200/90 dark:border-slate-800" />
              </div>
              ...
              {/* Bottom Nav Link */}
              <div className="h-4 w-48 mx-auto rounded-md bg-slate-100 dark:bg-slate-800/60 pt-2" />
