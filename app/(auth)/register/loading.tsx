    ...
    <div className="min-h-screen text-slate-800 dark:text-slate-200 flex flex-col justify-between bg-slate-50 dark:bg-[#070709] relative w-full font-sans antialiased select-none">
      ...
      <main className="flex-1 flex flex-col justify-center items-center p-4 py-8 md:p-6 lg:py-12 w-full max-w-7xl mx-auto z-10">
        <div className="w-full grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
          ...
          {/* Right Column: High-End Register Card */}
          <div className="lg:col-span-5 w-full flex justify-center items-center">
            <div className="w-full max-w-[440px] bg-white dark:bg-[#0c0c10] border border-slate-200/90 dark:border-slate-800 rounded-3xl p-6 sm:p-8 shadow-xl shadow-slate-900/5 dark:shadow-black/40 relative backdrop-blur-md animate-pulse">
              ...
              <div className="mb-6 text-center space-y-2">
                <div className="h-8 w-44 mx-auto rounded-xl bg-slate-200 dark:bg-slate-800" />
                <div className="h-4 w-60 mx-auto rounded-md bg-slate-100 dark:bg-slate-800/60" />
              </div>

              {/* Social Login Buttons */}
              <div className="grid grid-cols-2 gap-3 mb-4">
                <div className="h-11 rounded-xl bg-slate-100 dark:bg-slate-800/60 border border-slate-200/90 dark:border-slate-800" />
                <div className="h-11 rounded-xl bg-slate-100 dark:bg-slate-800/60 border border-slate-200/90 dark:border-slate-800" />
              </div>

              {/* Separator */}
              <div className="flex items-center gap-3 my-4">
                <div className="h-px flex-1 bg-slate-200/90 dark:border-slate-800" />
                <div className="h-2.5 w-24 rounded bg-slate-100 dark:bg-slate-800" />
                <div className="h-px flex-1 bg-slate-200/90 dark:border-slate-800" />
              </div>

              {/* 4 Form Inputs: Full Name, Email, Password, Confirm Password */}
              ...
              <div className="w-full h-11 sm:h-12 mt-3 bg-[#0059bb]/30 dark:bg-blue-600/30 rounded-xl" />

              {/* Bottom Switch Link */}
              <div className="h-4 w-44 mx-auto rounded-md bg-slate-100 dark:bg-slate-800/60 mt-6" />
