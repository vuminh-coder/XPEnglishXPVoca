      ...
      <div className="flex-1 flex flex-col justify-center items-center p-4 py-8 md:p-6 lg:py-12 w-full max-w-[1280px] mx-auto">
        <div className="w-full grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
          ...
          <div className="lg:col-span-5 w-full flex justify-center items-center">
            <div className="w-full max-w-[420px] bg-white dark:bg-[#121316] border border-slate-200/90 dark:border-white/10 rounded-xs p-6 sm:p-8 shadow-md space-y-3.5">
              ...
              <div className="space-y-2.5">
                <div className="space-y-1">
                  ...
                  <div className="h-9 w-full rounded-xs bg-slate-50 dark:bg-[#18191c] border border-slate-200 dark:border-white/10" />
                </div>
                <div className="space-y-1">
              ...
              {/* Bottom Nav Link */}
              <div className="h-4 w-44 mx-auto rounded-xs bg-slate-100 dark:bg-slate-800/60 pt-1" />
