      ...
      <div className="w-full max-w-[1600px] 2xl:max-w-[1760px] mx-auto px-3 sm:px-6 lg:px-8 xl:px-10 2xl:px-12 space-y-4 pt-1">
            ...
            <div className="flex items-center gap-4 sm:gap-5">
              ...
              <div className="space-y-2 min-w-0">
                <div className="flex items-center gap-2">
                  ...
                  <div className="h-4.5 w-20 rounded-md bg-sky-300/30" />
                </div>
                <div className="h-3.5 w-56 sm:w-72 rounded-md bg-blue-100/30" />
                <div className="h-3 w-32 rounded-md bg-blue-200/20" />
              </div>
            </div>

            <div className="h-11 w-44 rounded-xl bg-black/25 border border-white/15 shrink-0" />
          </div>
        </div>
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-2.5 sm:gap-3.5">
          {[1, 2, 3, 4].map((idx) => (
            <div
              key={idx}
              className="p-3.5 sm:p-4 rounded-2xl bg-white dark:bg-slate-900 border border-slate-200/90 dark:border-slate-800 shadow-2xs space-y-2.5"
            >
              ...
              <div className="space-y-1.5">
                ...
                <div className="h-1.5 sm:h-2 w-full rounded-full bg-slate-100 dark:bg-slate-800" />
              </div>
            </div>
          ))}
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-3.5 sm:gap-4 items-start">
          ...
          <div className="lg:col-span-8 space-y-3.5 sm:space-y-4">
            ...
            <div className="p-4 sm:p-5 rounded-2xl bg-white dark:bg-slate-900 border border-slate-200/90 dark:border-slate-800 shadow-2xs space-y-3.5">
              ...
              <div className="grid grid-cols-2 sm:grid-cols-5 gap-2 sm:gap-2.5 pt-1">
                {[1, 2, 3, 4, 5].map((s) => (
                  <div
                    key={s}
                    className="p-3 rounded-xl bg-slate-50/80 dark:bg-slate-800/50 border border-slate-200/70 dark:border-slate-800 space-y-1.5 text-center"
                  >
                    <div className="w-7 h-7 rounded-xl bg-slate-200 dark:bg-slate-700 mx-auto" />
                    <div className="h-2.5 w-12 rounded bg-slate-200 dark:bg-slate-800 mx-auto" />
                    <div className="h-3.5 w-10 rounded bg-slate-300 dark:bg-slate-700 mx-auto" />
                  </div>
                ))}
              </div>
            </div>
            ...
            <div className="p-4 sm:p-5 rounded-2xl bg-white dark:bg-slate-900 border border-slate-200/90 dark:border-slate-800 shadow-2xs space-y-3.5">
              <div className="flex items-center justify-between border-b border-slate-100 dark:border-slate-800 pb-3">
                ...
                <div className="h-6 w-40 rounded-lg bg-slate-100 dark:bg-slate-800" />
              </div>
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-2.5 sm:gap-3">
                {[1, 2, 3, 4].map((a) => (
                  <div
                    key={a}
                    className="p-3.5 rounded-xl border border-slate-200/80 dark:border-slate-800 space-y-2.5"
                  >
          ...
          <div className="lg:col-span-4 space-y-3.5 sm:space-y-4">
            ...
            <div className="p-4 sm:p-5 rounded-2xl bg-white dark:bg-slate-900 border border-slate-200/90 dark:border-slate-800 shadow-2xs space-y-3">
              <div className="h-4 w-28 rounded bg-slate-200 dark:bg-slate-800 border-b border-slate-100 dark:border-slate-800 pb-2.5" />
              <div className="space-y-1.5">
                {[1, 2, 3, 4].map((l) => (
                  <div key={l} className="h-10 w-full rounded-xl bg-slate-50 dark:bg-slate-800/60" />
                ))}
              </div>
            </div>
          </div>
