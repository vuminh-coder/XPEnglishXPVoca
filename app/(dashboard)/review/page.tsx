      ...
      <div className="bezel mb-6 animate-scale-in">
        <div className="bezel-inner p-6">
          <div className="flex items-center justify-between pb-4 border-b border-black/[0.04] dark:border-white/[0.04] mb-5">
            ...
            <span className="text-[9px] text-emerald-500 bg-emerald-50 dark:bg-emerald-950/30 px-2.5 py-0.5 rounded-full font-bold uppercase tracking-wider border border-emerald-200/50 dark:border-emerald-900/30">
          ...
          <div className="grid grid-cols-7 gap-2 text-center">
            {['T2', 'T3', 'T4', 'T5', 'T6', 'T7', 'CN'].map(d => (
              <div key={d} className="text-[10px] font-bold text-muted uppercase tracking-wider py-1">{d}</div>
            ))}
        ...
        <div className="bezel-inner p-6">
          <div className="flex justify-between items-center pb-4 border-b border-black/[0.04] dark:border-white/[0.04] mb-5">
            <div>
              ...
              <p className="text-[10px] text-muted font-medium mt-0.5">Hoàn thành để duy trì chuỗi trí nhớ tốt.</p>
            </div>
            {dueReviews.length > 0 && (
                  ...
                  <div className="bezel-inner p-4">
                    <div className="flex justify-between items-center mb-2.5">
                      <div>
                        ...
                        <span className="text-[9px] font-bold px-2 py-0.5 bg-cyan-100 dark:bg-cyan-950/50 text-cyan-700 dark:text-cyan-300 rounded-full uppercase ml-2">{v.pos}</span>
                      </div>
                      <span className="flex items-center gap-1 text-[9px] text-amber-500 bg-amber-50 dark:bg-amber-950/20 px-2 py-0.5 rounded-full font-bold uppercase border border-amber-200/50 dark:border-amber-900/30">
                    ...
                    <div className="text-[10px] text-muted leading-relaxed line-clamp-2">{v.definition}</div>
                  </div>
                </div>
              ))}
            </div>
