...
export default function GroupsPage() {
  ...
  return (
    <div className="space-y-3.5 sm:space-y-6 pb-16 md:pb-6 select-none font-sans" suppressHydrationWarning>
      ...
      <div className="p-3.5 sm:p-4.5 rounded-md bg-gradient-to-r from-[#0059bb] via-[#004799] to-[#312e81] text-white shadow-2xs relative overflow-hidden">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-3.5 sm:gap-5 items-start">
        ...
        <div className="lg:col-span-8 xl:col-span-8 space-y-3.5 sm:space-y-4">
          ...
          <div className="p-3 sm:p-4 rounded-md bg-white dark:bg-slate-900 border border-slate-200/80 dark:border-white/10 shadow-2xs flex flex-row items-center justify-between gap-3">
          ...
          <div className="space-y-3 sm:space-y-4">
            ...
            {loading ? (
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
                {[1, 2, 3, 4].map((i) => (
                  <div key={i} className="p-3.5 sm:p-4 rounded-md bg-white dark:bg-slate-900 border border-slate-200/80 dark:border-white/10 shadow-2xs space-y-3 animate-pulse">
              ...
              <div className="p-6 sm:p-8 rounded-md bg-white dark:bg-slate-900 border border-slate-200/80 dark:border-white/10 text-center space-y-2">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
                {groups.map((g) => (
                  <div
                    key={g.id}
                    className="p-3.5 sm:p-4 rounded-md bg-white dark:bg-slate-900 border border-slate-200/80 dark:border-white/10 shadow-2xs flex flex-col justify-between space-y-3 sm:space-y-3.5 hover:border-[#0059bb]/40 transition-all"
                  >
