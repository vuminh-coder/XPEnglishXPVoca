...
export default function LeaderboardPage() {
  ...
  return (
    <div className="space-y-3.5 sm:space-y-5 pb-16 md:pb-6 select-none font-sans" suppressHydrationWarning>
      ...
      <div className="p-3.5 sm:p-5 rounded-md sm:rounded-lg bg-gradient-to-r from-[#0059bb] via-[#004799] to-[#002b5b] text-white shadow-xs relative overflow-hidden">
        ...
        <div className="relative z-10 space-y-2 sm:space-y-3">
          ...
          <div className="flex items-center justify-between gap-2">
            <div className="flex items-center gap-1.5 sm:gap-2 flex-nowrap whitespace-nowrap overflow-x-auto no-scrollbar">
              <span className="px-2 py-1 sm:px-2.5 sm:py-1 rounded-xs text-[9px] sm:text-[10.5px] font-black uppercase tracking-wider bg-amber-400/20 text-amber-200 border border-amber-300/30 flex items-center gap-1 font-display shrink-0">
                <Trophy className="w-3 h-3 sm:w-3.5 sm:h-3.5 text-amber-300" /> Bảng Xếp Hạng Tuần
              </span>
              <span className="hidden sm:inline-block px-2 py-1 sm:px-2.5 sm:py-1 rounded-xs text-[9px] sm:text-[10.5px] font-bold bg-white/15 text-white border border-white/20 font-mono shrink-0">
          ...
          <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3">
            ...
            <div className="hidden sm:flex items-center gap-3 shrink-0 p-3 rounded-sm bg-white/10 dark:bg-slate-900/60 border border-white/15 backdrop-blur-md">
        ...
        <div className="lg:col-span-8 space-y-3.5 sm:space-y-4">
          ...
          {loading ? (
            ...
            <div className="space-y-4">
              <div className="p-4 sm:p-6 rounded-md sm:rounded-lg bg-white dark:bg-slate-900 border border-slate-200/80 dark:border-white/10 shadow-xs space-y-4 animate-pulse">
                ...
                <div className="flex items-end justify-center gap-2.5 sm:gap-4 h-44 sm:h-48 pt-4">
                  <div className="w-20 sm:w-24 h-28 sm:h-32 bg-slate-100 dark:bg-slate-800/60 rounded-t-lg" />
                  <div className="w-24 sm:w-28 h-36 sm:h-40 bg-amber-500/10 rounded-t-lg" />
                  <div className="w-20 sm:w-24 h-20 sm:h-24 bg-slate-100 dark:bg-slate-800/60 rounded-t-lg" />
                </div>
              </div>
            </div>
          ) : (
            <div className="space-y-3.5 sm:space-y-4">
              ...
              <div className="p-3 sm:p-5 rounded-md sm:rounded-lg bg-white dark:bg-slate-900 border border-slate-200/80 dark:border-white/10 shadow-xs space-y-3 sm:space-y-4">
                <div className="flex items-center justify-between border-b border-slate-100 dark:border-white/5 pb-2 sm:pb-2.5">
                  <h2 className="text-[11px] sm:text-xs font-black uppercase tracking-widest text-[#0059bb] dark:text-sky-400 flex items-center gap-1.5 font-display">
                    <Trophy className="w-3.5 h-3.5 sm:w-4 sm:h-4 text-amber-500" /> Bảng Vinh Danh Quán Quân Tuần
                  </h2>
                ...
                <div className="grid grid-cols-3 gap-1.5 sm:gap-4 items-end pt-1.5 sm:pt-2 pb-1">
                  ...
                  {top2 && (
                    <div className="p-2 sm:p-4 rounded-md sm:rounded-lg bg-gradient-to-b from-slate-200/80 via-slate-100/50 to-white dark:from-slate-800 dark:to-slate-900 border-2 border-slate-300 dark:border-slate-600 shadow-xs text-center flex flex-col items-center justify-between space-y-1.5 sm:space-y-2 relative group hover:border-slate-400 transition-all">
                  ...
                  {top1 && (
                    <div className="p-2.5 sm:p-5 rounded-md sm:rounded-lg bg-gradient-to-b from-amber-500/25 via-amber-400/10 to-amber-500/5 dark:from-amber-500/30 dark:via-slate-900 dark:to-slate-900 border-2 border-amber-400 shadow-lg text-center flex flex-col items-center justify-between space-y-2 sm:space-y-2.5 relative group -top-2.5 sm:-top-3 z-10 transition-all">
                  ...
                  {top3 && (
                    <div className="p-2 sm:p-4 rounded-md sm:rounded-lg bg-gradient-to-b from-amber-800/20 via-amber-800/10 to-white dark:from-amber-950/60 dark:to-slate-900 border-2 border-amber-700/50 dark:border-amber-800/60 shadow-xs text-center flex flex-col items-center justify-between space-y-1.5 sm:space-y-2 relative group hover:border-amber-700 transition-all">
              ...
              <div className="p-3 sm:p-4 rounded-md sm:rounded-lg bg-white dark:bg-slate-900 border border-slate-200/80 dark:border-white/10 shadow-xs space-y-2.5">
                <h3 className="text-xs font-bold uppercase tracking-wider text-slate-500 dark:text-slate-400 flex items-center gap-1.5 border-b border-slate-100 dark:border-white/5 pb-2 font-display">
                  <TrendingUp className="w-3.5 h-3.5 sm:w-4 sm:h-4 text-[#0059bb] dark:text-sky-400" /> Danh Sách Học Viên Bứt Phá:
                </h3>
                ...
                <div className="space-y-1.5">
                  {otherLeaders.map((l) => {
                    ...
                    return (
                      <div
                        key={l.id}
                        className={`p-2 sm:p-2.5 rounded-sm sm:rounded-md border flex items-center justify-between gap-2.5 sm:gap-3 transition-all ${
                          isCurrentUser
                      ...
                      >
                        <div className="flex items-center gap-2 sm:gap-2.5 min-w-0">
                          {/* Rank Badge */}
                          <div className="w-6 h-6 sm:w-7 sm:h-7 rounded-sm bg-slate-200/80 dark:bg-slate-700 flex items-center justify-center text-[11px] sm:text-xs font-black text-slate-700 dark:text-slate-200 shrink-0 font-mono">
                            #{l.rank}
                          </div>
                        ...
                        {/* XP Badge */}
                        <div className="px-2 py-0.5 sm:px-2.5 sm:py-1 rounded-sm bg-[#0059bb]/10 text-[#0059bb] dark:text-sky-400 border border-[#0059bb]/20 font-black text-[11px] sm:text-xs shrink-0 font-mono">
                          {l.xp} XP
                        </div>
                      </div>
                    );
        ...
        <div className="lg:col-span-4 space-y-3.5 sm:space-y-4 sticky top-4">
          ...
          <div className="p-3.5 sm:p-4.5 rounded-md sm:rounded-lg bg-white dark:bg-slate-900 border border-slate-200/80 dark:border-white/10 shadow-xs space-y-2.5 sm:space-y-3">
            ...
            <div className="grid grid-cols-2 gap-2 text-center">
              <div className="p-2 sm:p-2.5 rounded-sm bg-slate-50 dark:bg-slate-800/60 border border-slate-200/60 dark:border-white/5">
            ...
            <div className="space-y-1 bg-slate-50 dark:bg-slate-800/40 p-2 sm:p-2.5 rounded-sm border border-slate-200/60 dark:border-white/5">
          ...
          <div className="p-3.5 sm:p-4.5 rounded-md sm:rounded-lg bg-white dark:bg-slate-900 border border-slate-200/80 dark:border-white/10 shadow-xs space-y-2 sm:space-y-2.5">
            <div className="flex items-center gap-1.5 sm:gap-2 border-b border-slate-100 dark:border-white/5 pb-2 text-xs font-bold text-slate-900 dark:text-white font-display">
              <Zap className="w-3.5 h-3.5 sm:w-4 sm:h-4 text-amber-500" /> Nhiệm Vụ Tích Lũy XP Nhanh
            </div>

            <div className="space-y-1.5 sm:space-y-2">
              <Link
                href="/study/grammar"
                className="p-2 sm:p-2.5 rounded-sm bg-slate-50 dark:bg-slate-800/60 hover:bg-[#0059bb] hover:text-white text-slate-700 dark:text-slate-300 border border-slate-200/60 text-xs font-bold transition-all flex items-center justify-between cursor-pointer group"
              >
          ...
          <div className="p-3.5 sm:p-4.5 rounded-md sm:rounded-lg bg-sky-50/70 dark:bg-sky-950/30 border border-[#0059bb]/30 shadow-xs space-y-1.5 sm:space-y-2">
            <div className="flex items-center gap-1.5 text-xs font-bold text-[#0059bb] dark:text-sky-400 font-display">
              <Award className="w-3.5 h-3.5 sm:w-4 sm:h-4 text-amber-500" /> Thưởng Cuối Tuần
            </div>
