...
export default function LeaderboardPage() {
  ...
  return (
    <div className="space-y-3.5 sm:space-y-5 pb-16 md:pb-6 select-none font-sans" suppressHydrationWarning>
      ...
      <div className="p-3.5 sm:p-4.5 rounded-md bg-gradient-to-r from-[#0059bb] via-[#004799] to-[#002b5b] text-white shadow-2xs relative overflow-hidden">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-3.5 sm:gap-4 items-start">
        ...
        <div className="lg:col-span-8 space-y-3.5 sm:space-y-4">
          ...
          {loading ? (
            ...
            <div className="space-y-4">
              <div className="p-4 sm:p-6 rounded-md bg-white dark:bg-slate-900 border border-slate-200/80 dark:border-white/10 shadow-2xs space-y-4 animate-pulse">
                ...
                <div className="flex items-end justify-center gap-2.5 sm:gap-4 h-44 sm:h-48 pt-4">
                  <div className="w-20 sm:w-24 h-28 sm:h-32 bg-slate-100 dark:bg-slate-800/60 rounded-t-md" />
                  <div className="w-24 sm:w-28 h-36 sm:h-40 bg-amber-500/10 rounded-t-md" />
                  <div className="w-20 sm:w-24 h-20 sm:h-24 bg-slate-100 dark:bg-slate-800/60 rounded-t-md" />
                </div>
              </div>
            </div>
          ) : (
            <div className="space-y-3.5 sm:space-y-4">
              ...
              <div className="p-3 sm:p-4 rounded-md bg-white dark:bg-slate-900 border border-slate-200/80 dark:border-white/10 shadow-2xs space-y-3 sm:space-y-4">
              ...
              <div className="p-3 sm:p-4 rounded-md bg-white dark:bg-slate-900 border border-slate-200/80 dark:border-white/10 shadow-2xs space-y-2.5">
        ...
        <div className="lg:col-span-4 space-y-3.5 sm:space-y-4 sticky top-4">
          ...
          <div className="p-3.5 sm:p-4 rounded-md bg-white dark:bg-slate-900 border border-slate-200/80 dark:border-white/10 shadow-2xs space-y-2 sm:space-y-2.5">
          ...
          <div className="p-3.5 sm:p-4 rounded-md bg-sky-50/70 dark:bg-sky-950/30 border border-[#0059bb]/30 shadow-2xs space-y-1.5 sm:space-y-2">
