  ...
  return (
    <div className="animate-fade-in max-w-3xl mx-auto space-y-6 pb-20 md:pb-6">
      ...
      <div className="flex gap-1.5 justify-center mb-6 bg-black/[0.025] dark:bg-white/[0.025] p-1 rounded-full w-fit mx-auto border border-black/[0.03] dark:border-white/[0.03] animate-scale-in">
        ...
        <Link href="/community/leaderboard" className="px-4 py-2 text-xs font-bold rounded-full text-slate-450 dark:text-slate-500 hover:text-slate-700 dark:hover:text-slate-350 transition-all duration-300">Bảng xếp hạng</Link>
        <Link href="/community/friends" className="px-4 py-2 text-xs font-bold rounded-full text-slate-450 dark:text-slate-500 hover:text-slate-700 dark:hover:text-slate-350 transition-all duration-300">Bạn bè</Link>
        <Link href="/community/groups" className="px-4 py-2 text-xs font-bold rounded-full text-slate-450 dark:text-slate-500 hover:text-slate-700 dark:hover:text-slate-350 transition-all duration-300">Nhóm học tập</Link>
      </div>
                  ...
                  <div className="bezel-inner rounded-[calc(2rem-6px)] bg-white dark:bg-[#0c0c0e] p-5">
                    ...
                    <div className="flex items-center gap-3 mb-4">
                      ...
                      <div>
                        ...
                        <div className="text-[10px] text-slate-455 font-bold uppercase tracking-wider mt-0.5">{p.meta}</div>
                      </div>
                    </div>
                    ...
                    <div className={`mt-4 pt-4 border-t border-black/[0.04] dark:border-white/[0.04] ${activeCommentId === p.id ? 'block animate-fade-in-up' : 'hidden'}`}>
                      <div className="flex gap-2 mb-4">
                        ...
                        <Button 
                          ...
                          className="font-bold py-2 px-4 flex items-center gap-1.5"
                        >
                        ...
                        {shownComments.map((c: any) => (
                          <div key={c.id} className="flex gap-3 bg-neutral-50/40 dark:bg-neutral-900/20 p-3 rounded-xl border border-black/[0.02] dark:border-white/[0.02]">
                            ...
                            <div className="flex-1">
                              ...
                              <div className="text-xs text-slate-650 dark:text-slate-350 mt-1 leading-relaxed font-medium">{c.content}</div>
                            </div>
                          </div>
                        ))}
                      </div>
