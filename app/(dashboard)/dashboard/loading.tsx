      ...
      <div className="w-full max-w-[1600px] 2xl:max-w-[1760px] mx-auto px-4 sm:px-6 lg:px-8 xl:px-10 2xl:px-12 py-5 sm:py-6 space-y-5 sm:space-y-6">
        ...
        <div className="p-3.5 rounded-2xl bg-white dark:bg-slate-900 border border-slate-200/90 dark:border-slate-800 flex items-center justify-between gap-3 shadow-xs h-14">
          <div className="flex items-center gap-3">
            ...
            <div className="space-y-1.5">
              <div className="h-4 w-44 sm:w-72 rounded-md bg-slate-200 dark:bg-slate-800" />
              <div className="h-3 w-28 sm:w-96 rounded-md bg-slate-100 dark:bg-slate-800/60 hidden sm:block" />
            </div>
          </div>
          <div className="h-8 w-20 rounded-xl bg-slate-200 dark:bg-slate-800 shrink-0" />
        </div>
        ...
        <div className="p-4 sm:p-5 rounded-2xl bg-white dark:bg-slate-900 border border-slate-200/90 dark:border-slate-800 shadow-md shadow-slate-200/50 dark:shadow-black/40 space-y-4">
          ...
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
            <div className="flex items-center gap-3.5">
              <div className="w-12 h-12 sm:w-13 sm:h-13 rounded-full bg-slate-200 dark:bg-slate-800 shrink-0 ring-2 ring-slate-100 dark:ring-slate-800" />
              <div className="space-y-2">
                <div className="flex items-center gap-2">
                  <div className="h-5.5 w-40 sm:w-56 rounded-md bg-slate-200 dark:bg-slate-800" />
                  <div className="h-4.5 w-16 rounded-md bg-blue-600/20 dark:bg-blue-500/20" />
                </div>
                <div className="h-3.5 w-32 sm:w-52 rounded-md bg-slate-100 dark:bg-slate-800/60" />
              </div>
            </div>

            {/* Top Right Action Pills */}
            <div className="flex items-center gap-2">
              <div className="h-9 w-28 rounded-xl bg-slate-100 dark:bg-slate-800 border border-slate-200/60 dark:border-slate-700/50" />
              <div className="h-9 w-24 rounded-xl bg-slate-100 dark:bg-slate-800 border border-slate-200/60 dark:border-slate-700/50" />
            </div>
          </div>
          ...
          <div className="lg:col-span-7 space-y-5 sm:space-y-6">
            ...
            <div className="p-4 sm:p-5 rounded-2xl bg-gradient-to-br from-[#0059bb]/25 via-blue-600/20 to-sky-600/15 dark:from-[#0059bb]/35 dark:via-blue-950/60 dark:to-slate-900 border border-blue-500/30 dark:border-blue-500/40 shadow-md space-y-3.5">
              ...
              <div className="flex items-center justify-between">
                <div className="h-6 w-36 rounded-md bg-blue-600/30 dark:bg-blue-400/20" />
                <div className="h-5 w-24 rounded-full bg-white/20 dark:bg-white/10" />
              </div>

              {/* Lesson Title Lines */}
              <div className="space-y-1.5">
                <div className="h-6 w-3/4 rounded-md bg-white/40 dark:bg-white/20" />
                <div className="h-4 w-1/2 rounded-md bg-white/25 dark:bg-white/15" />
              </div>
              ...
              <div className="grid grid-cols-3 gap-2 sm:gap-3 pt-1">
                {[1, 2, 3].map((pod) => (
                  ...
                  >
                    <div className="h-2.5 w-12 mx-auto rounded bg-white/30 dark:bg-white/20" />
                    <div className="h-4 w-14 mx-auto rounded bg-white/50 dark:bg-white/30" />
                  </div>
                ))}
              </div>

              {/* Progress Bar & Clean White Button CTA (Nằm ngang nhau 100%) */}
              <div className="flex items-center justify-between gap-2.5 sm:gap-4 pt-3 sm:pt-3.5 border-t border-white/20 relative z-10">
                <div className="flex-1 min-w-0 sm:max-w-xs space-y-1">
                  <div className="h-2 sm:h-2.5 rounded-full bg-white/20 dark:bg-white/10 border border-white/20 overflow-hidden">
                    <div className="h-full w-1/2 rounded-full bg-amber-400/60" />
                  </div>
                </div>

                <div className="shrink-0">
                  <div className="h-9 sm:h-10 w-36 sm:w-44 rounded-xl bg-white/90 dark:bg-white/20 shadow-md" />
                </div>
              </div>
            </div>
            ...
            <div className="p-4 sm:p-5 rounded-2xl bg-white dark:bg-slate-900 border border-slate-200/90 dark:border-slate-800 shadow-md space-y-3.5">
              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-2">
                  ...
                  <div className="h-5 w-44 sm:w-56 rounded-md bg-slate-200 dark:bg-slate-800" />
                </div>
                <div className="h-6 w-20 rounded-lg bg-blue-500/15" />
              </div>
              ...
              <div className="relative pt-2 pb-0 bg-slate-50/70 dark:bg-slate-950/70 rounded-xl border border-slate-200/70 dark:border-slate-800/80 overflow-hidden space-y-3 p-3">
                <div className="space-y-4 py-2">
                  {[1, 2, 3, 4, 5].map((line) => (
                    <div key={line} className="flex items-center gap-3">
                      <div className="h-3 w-8 rounded bg-slate-200 dark:bg-slate-800 shrink-0" />
                      <div className="h-px flex-1 bg-slate-200/60 dark:bg-slate-800 border-dashed border-t border-slate-300/40 dark:border-slate-700/40" />
                    </div>
                  ))}
                </div>
                ...
                <div className="grid grid-cols-7 gap-1 pt-1 border-t border-slate-200/50 dark:border-slate-800">
                  {[1, 2, 3, 4, 5, 6, 7].map((day) => (
                    <div key={day} className="h-4 w-10 mx-auto rounded bg-slate-200 dark:bg-slate-800" />
                  ))}
                </div>
              </div>
              ...
              <div className="p-3 rounded-xl bg-emerald-500/10 dark:bg-emerald-950/30 border border-emerald-500/20 flex items-center justify-between gap-3">
                <div className="flex items-center gap-3">
                  ...
                  <div className="space-y-1">
                    <div className="h-4 w-44 rounded bg-emerald-600/30 dark:bg-emerald-400/20" />
                    <div className="h-3 w-32 rounded bg-emerald-600/20 dark:bg-emerald-400/10 hidden sm:block" />
                  </div>
                </div>
                <div className="h-8 w-24 rounded-lg bg-emerald-600/20 dark:bg-emerald-500/20 shrink-0" />
              </div>
            </div>
            ...
            <div className="p-4 sm:p-5 rounded-2xl bg-white dark:bg-slate-900 border border-slate-200/90 dark:border-slate-800 shadow-md space-y-3">
              ...
              <div className="flex gap-2">
                <div className="h-11 flex-1 rounded-xl bg-slate-100 dark:bg-slate-800/60 border border-slate-200/60 dark:border-slate-700/50" />
                <div className="h-11 w-11 rounded-xl bg-purple-600/30 dark:bg-purple-500/30 shrink-0" />
              </div>
            </div>
          </div>
          ...
          <div className="lg:col-span-5 space-y-5 sm:space-y-6">
            ...
            <div className="p-4 sm:p-5 rounded-2xl bg-white dark:bg-slate-900 border border-slate-200/90 dark:border-slate-800 shadow-md space-y-3.5">
              <div className="flex items-center justify-between">
                ...
                <div className="h-6 w-20 rounded-lg bg-orange-500/15" />
              </div>
              ...
              {/* Claim Reward Button */}
              <div className="h-10 rounded-xl bg-amber-500/20 dark:bg-amber-500/15 w-full" />
            </div>
                ...
                {[1, 2, 3, 4].map((userItem) => (
                  ...
                  >
                    <div className="flex items-center gap-2.5">
                      ...
                      <div className="h-4 w-24 sm:w-32 rounded bg-slate-200 dark:bg-slate-800" />
                    </div>
        ...
        <div className="space-y-3 pt-2">
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2">
              <div className="h-5 w-44 sm:w-56 rounded-md bg-slate-200 dark:bg-slate-800" />
              <div className="h-4.5 w-16 rounded-md bg-purple-500/20 hidden sm:block" />
            </div>
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-2.5 sm:gap-3.5">
            {[
              ...
              >
                ...
                <div className="space-y-1.5 flex-1 min-w-0">
                  <div className="h-4 w-20 sm:w-28 rounded bg-slate-200 dark:bg-slate-800" />
                  <div className="h-3 w-16 rounded bg-slate-100 dark:bg-slate-800/60 hidden sm:block" />
                </div>
              </div>
            ))}
          </div>
