    ...
    <div className="space-y-3.5 pb-20 sm:pb-6 px-1 md:px-0 relative select-none font-sans">
      ...
      >
        ...
        <div className="flex items-center gap-2 shrink-0 self-end md:self-auto">
          <button
            ...
            className="px-3 py-1.5 rounded-xs bg-[#20b26c] hover:bg-[#1b9a5d] text-white text-xs font-bold transition-all shadow-2xs flex items-center gap-1 cursor-pointer"
          >
            <CheckCircle2 className="w-3.5 h-3.5" /> Hoàn thành & Chấm điểm
          </button>

          <span className="px-2.5 py-1.5 rounded-xs bg-amber-500/10 text-amber-600 dark:text-amber-400 border border-amber-500/20 text-xs font-black flex items-center gap-1 shadow-2xs">
      ...
      >
        ...
        <div className="flex items-center gap-1.5 shrink-0">
          <button
            onClick={handleFinishConversation}
            className="px-2 py-1 rounded-xs bg-[#20b26c] hover:bg-[#1b9a5d] text-white text-[10px] font-bold shadow-2xs flex items-center gap-1 cursor-pointer"
          >
            <CheckCircle2 className="w-3 h-3" /> Chấm điểm
          </button>
          <span className="px-1.5 py-1 rounded-xs bg-amber-500/10 text-amber-600 dark:text-amber-400 text-[10px] font-black flex items-center gap-1">
          ...
          <div className="flex items-center gap-1">
            {[
              ...
              <button
                ...
                className={`px-1.5 sm:px-2 py-0.5 rounded-xs text-[9px] sm:text-[10px] font-bold transition-all cursor-pointer whitespace-nowrap ${
                  levelFilter === lvl.id
            ...
            return (
              ...
              >
                <div className="flex items-center justify-between">
                  <div className="w-6.5 h-6.5 sm:w-7 sm:h-7 rounded-xs bg-slate-100 dark:bg-slate-800 flex items-center justify-center shrink-0">
                    {TOPIC_ICONS[topic.id] || <MessageSquare className="w-3.5 h-3.5 text-[#1d6ee6]" />}
                  </div>
                  <span className="px-1.5 py-0.2 rounded-xs text-[8px] sm:text-[9px] font-black bg-slate-100 dark:bg-slate-800 text-slate-700 dark:text-slate-300">
                    {levelLabel}
                  </span>
                </div>
        ...
        <div className="lg:col-span-7 space-y-3.5">
          ...
          <div className="p-4 rounded-xs bg-white dark:bg-slate-900 border border-slate-200/80 dark:border-white/10 shadow-xs space-y-3 min-w-0">
            ...
            <div className="flex items-center justify-between border-b border-slate-100 dark:border-white/5 pb-2">
              ...
              <span className="px-2 py-0.5 rounded-xs text-[10px] font-bold bg-[#1d6ee6]/10 text-[#1d6ee6] shrink-0">
                1-1 Companion
              </span>
            </div>
                        ...
                        <div className="flex flex-wrap gap-1 pt-1">
                          ...
                          {msg.suggestions.map((sug, sIdx) => (
                            <button
                              ...
                              className="px-2 py-1 rounded-xs text-[10px] font-bold bg-blue-50 dark:bg-blue-950/40 text-[#1d6ee6] dark:text-sky-400 border border-blue-200/50 hover:bg-blue-100 transition-colors cursor-pointer"
                            >
                              💬 {sug}
                            </button>
                          ))}
              ...
              >
                <div className="relative flex-1">
                  <input
                    ...
                    className="w-full h-9 pl-3 pr-9 text-xs font-medium rounded-xs bg-slate-50 dark:bg-slate-950 border border-slate-200 dark:border-white/10 text-slate-900 dark:text-white focus:outline-none focus:border-[#1d6ee6]"
                  />
                  <button
                    type="button"
                    onClick={isListening ? stopListening : startListening}
                    className={`absolute right-2 top-1.5 p-1 rounded-xs transition-colors cursor-pointer ${
                      isListening
                ...
                <button
                  ...
                  className="h-9 px-3.5 rounded-xs bg-[#1d6ee6] hover:bg-[#155bc5] disabled:opacity-40 text-white text-xs font-bold flex items-center gap-1 shadow-2xs cursor-pointer shrink-0"
                >
            ...
            <div className="space-y-1.5">
              {currentTopic.goals.map((goal) => {
                ...
                return (
                  <div
                    key={goal.id}
                    className={`p-2.5 rounded-xs border text-xs font-bold flex items-center justify-between gap-2 transition-all ${
                      isDone
          ...
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-950/60 backdrop-blur-xs">
            ...
            >
              ...
              <button
                ...
                className="w-full py-2 rounded-xs bg-[#1d6ee6] hover:bg-[#155bc5] text-white text-xs font-bold shadow-2xs cursor-pointer"
              >
                Nhận +30 XP & Hoàn tất
              </button>
            </motion.div>
