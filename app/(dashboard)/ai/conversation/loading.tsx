  ...
  return (
    <div className="space-y-3 pb-24 md:pb-6 px-1.5 sm:px-0 relative select-none font-sans animate-pulse lg:flex lg:flex-col lg:min-h-[calc(100vh-4rem)]">
      ...
      <div className="p-3 sm:p-4 rounded-xs bg-[#0059bb]/5 dark:bg-blue-950/40 border border-[#0059bb]/15 dark:border-blue-900/50 flex flex-col sm:flex-row sm:items-center justify-between gap-2.5 sm:gap-3 shadow-2xs shrink-0">
        <div className="flex items-center gap-2.5 sm:gap-3 min-w-0">
          ...
          <div className="flex items-center gap-2 flex-wrap">
            <div className="h-5 w-24 rounded-xs bg-blue-600/30 dark:bg-blue-500/20 shrink-0" />
            <div className="h-5 w-40 rounded-xs bg-slate-300 dark:bg-slate-800" />
          </div>
        </div>
        <div className="flex items-center justify-between sm:justify-end gap-2 shrink-0 w-full sm:w-auto">
          <div className="h-8 flex-1 sm:flex-initial sm:w-36 rounded-xs bg-emerald-600/30 dark:bg-emerald-500/30 shrink-0" />
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-3 lg:gap-3.5 lg:items-stretch min-w-0 lg:flex-1 lg:min-h-0 mt-1">
        ...
        {/* Cột Trái: AI Chat Companion (8/12 Width) */}
        ...
        {/* Cột Phải: Unified Single Sidebar Skeleton (4/12 Width) */}
