          ...
          <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-3">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-2 shrink-0">
              ...
              <div className="px-3 py-1.5 rounded-xl bg-slate-50 dark:bg-slate-950 border border-slate-200/80 dark:border-slate-800/80 flex items-center gap-2 shadow-2xs">
                ...
                <div className="min-w-0">
                  <span className="text-[10px] text-slate-400 font-bold block leading-none">Ví Dụ</span>
                  <span className="text-xs font-bold text-amber-600 dark:text-amber-400 truncate block mt-0.5">{lessonData?.examples?.length || 4} Mẫu câu</span>
                </div>
              </div>
                              ...
                              {isAnswered && (
                                ...
                                >
                                  ...
                                  <div className="pt-2 border-t border-slate-200/60 dark:border-slate-800/80 text-xs sm:text-sm leading-relaxed text-slate-800 dark:text-slate-200 font-medium flex items-start gap-2">
                                    ...
                                    <div>
                                      <span className="font-bold text-[#0059bb] dark:text-sky-400 mr-1">AI Giải thích chi tiết:</span>
                            ...
                            return (
                              ...
                              >
                                <div className="flex items-start justify-between gap-2">
                                  ...
                                  <span className={`px-2.5 py-0.5 rounded-lg text-[10px] font-bold uppercase shrink-0 flex items-center gap-1 ${
                                    ...
                                    {isCorrect ? (
                                      <>
                                        <CheckCircle2 className="w-3 h-3 text-emerald-600 dark:text-emerald-400" strokeWidth={2.5} />
                                        <span>Đúng</span>
                                      </>
                                    ) : (
                                      <>
                                        <XCircle className="w-3 h-3 text-rose-600 dark:text-rose-400" strokeWidth={2.5} />
                                        <span>Sai</span>
                                      </>
                                    )}
                                  </span>
                                ...
                                <div className="text-xs text-slate-700 dark:text-slate-300 font-medium leading-relaxed pt-2 border-t border-slate-200/60 dark:border-slate-800 flex items-start gap-1.5">
                                  <Lightbulb className="w-3.5 h-3.5 text-amber-500 shrink-0 mt-0.5" />
                                  <div>
                                    <span className="font-bold text-amber-600 dark:text-amber-400 mr-1">AI Giải thích:</span>
                ...
                {chatMessages.length === 0 ? (
                  <div className="p-4 text-center rounded-2xl bg-purple-50/70 dark:bg-purple-950/30 border border-purple-200/60 dark:border-purple-800/40 text-xs text-purple-900 dark:text-purple-300 font-medium space-y-1 shadow-2xs">
                    <div className="font-bold flex items-center justify-center gap-1.5">
                      ...
                      <span>Bạn có thắc mắc về bài thi hay cấu trúc ngữ pháp này không?</span>
                    </div>
