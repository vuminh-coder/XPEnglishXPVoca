  ...
  return (
    <div className="max-w-md mx-auto p-6 sm:p-8 rounded-2xl bg-white dark:bg-slate-900 border border-slate-200/90 dark:border-slate-800 shadow-md text-center space-y-5 animate-in fade-in zoom-in-95 duration-200">
      ...
      <div className="space-y-1.5">
        ...
        {score !== undefined && (
          <div className="text-2xl sm:text-3xl font-black text-[#0059bb] dark:text-sky-400 font-display">
            {score} Điểm
          </div>
        )}
      ...
      <div className="flex gap-3 justify-center pt-2">
        ...
        <button
          type="button"
          onClick={onRestart}
          className="py-2.5 px-5 rounded-xl bg-[#0059bb] hover:bg-[#004799] text-white text-xs font-bold transition-all cursor-pointer flex items-center gap-1.5 active:scale-95 shadow-md shadow-blue-500/20"
        >
