 ...
 * Bao gồm: Top bar → Search → Lesson cards grid (2 rows)
 */
      ...
      <div className="flex-1 px-4 sm:px-6 lg:px-8 py-5 space-y-6">
        ...
        <div className="p-4 rounded-xl bg-white dark:bg-slate-900 border border-slate-200/80 dark:border-slate-800 shadow-sm flex items-center justify-between gap-4">
          <div className="flex items-center gap-3 min-w-0">
            <div className="w-10 h-10 rounded-lg bg-blue-500/20 dark:bg-blue-500/10 shrink-0" />
          ...
          <div className="h-8 w-32 rounded-lg bg-blue-500/20 dark:bg-blue-500/10 shrink-0 hidden sm:block" />
        </div>
            ...
            {[1, 2, 3, 4].map((i) => (
              ...
              >
                ...
                <div className="py-0.5 sm:py-0 sm:mt-2.5 space-y-2 flex-1 flex flex-col justify-between min-w-0">
                  <div>
                    <div className="h-3 w-16 rounded bg-blue-500/20 mb-1 sm:hidden" />
                  ...
                  <div className="flex items-center justify-between pt-1 sm:pt-2 sm:border-t border-slate-100 dark:border-slate-800">
                    ...
                    <div className="h-5 w-16 rounded-lg bg-slate-100 dark:bg-slate-800 border border-slate-200/80 dark:border-slate-700/80" />
                  </div>
                </div>
              </div>
            ))}
...
/**
 * Skeleton cho trang Listening dạng STUDIO (khi đã chọn bài, có ?id=)
 * Bao gồm: StudioTopHeader → Mobile tabs → 2-column (Waveform + DictationWorkspace | TranscriptSidebar)
 */
  ...
  return (
    <div className="w-full h-screen max-h-screen flex flex-col overflow-hidden select-none font-sans animate-pulse bg-white dark:bg-slate-950">
      ...
      <div className="flex lg:hidden items-center border-b border-slate-200/80 dark:border-slate-800 px-4 pt-2.5 gap-6 shrink-0">
        <div className="pb-2.5"><div className="h-4 w-28 rounded-md bg-slate-200 dark:bg-slate-800" /></div>
        <div className="pb-2.5"><div className="h-4 w-32 rounded-md bg-slate-100 dark:bg-slate-800/60" /></div>
      </div>
      ...
      <div className="flex-1 flex flex-col lg:flex-row items-stretch min-h-0 overflow-hidden">
        ...
        <div className="flex-1 min-w-0 p-2.5 sm:p-3 lg:p-3.5 space-y-2 overflow-hidden">
          ...
          <div className="p-3 sm:p-3.5 rounded-xl bg-white dark:bg-slate-900 border border-slate-200/90 dark:border-slate-800 shadow-sm space-y-2.5">
            ...
            <div className="h-14 sm:h-16 rounded-lg bg-slate-100 dark:bg-slate-800/60 flex items-end justify-center gap-0.5 p-2 overflow-hidden">
          ...
          {/* Token row */}
          <div className="p-2 sm:p-2.5 rounded-xl bg-white dark:bg-slate-900 border border-slate-200/90 dark:border-slate-800 shadow-sm">
            <div className="flex items-center gap-1.5 sm:gap-2 overflow-hidden">
              {[48, 72, 32, 56, 40, 88, 48, 64, 40, 52].map((w, i) => (
          ...
          {/* Input field */}
          <div className="h-10 sm:h-11 w-full rounded-xl bg-white dark:bg-slate-900 border border-slate-200/90 dark:border-slate-800 shadow-2xs" />

          {/* Action buttons */}
          <div className="flex items-center justify-between px-1">
            <div className="flex items-center gap-1.5">
              {[100, 80].map((w, i) => (<div key={i} className="rounded-xl bg-slate-100 dark:bg-slate-800/60 border border-slate-200/90 dark:border-slate-800" style={{ width: w, height: 34 }} />))}
            </div>
            <div className="flex items-center gap-1.5">
