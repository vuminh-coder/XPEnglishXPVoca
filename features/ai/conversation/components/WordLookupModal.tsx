      ...
      {wordData && (
        <>
          ...
          <motion.div
            ...
            className="fixed left-3 right-3 bottom-4 sm:left-auto sm:right-6 sm:bottom-6 z-50 w-auto sm:w-84 p-3.5 sm:p-4 rounded-2xl bg-white dark:bg-slate-900 border border-slate-200/90 dark:border-slate-800 shadow-2xl space-y-2.5 sm:space-y-3 select-none"
          >
            {/* Header */}
            <div className="flex items-center justify-between border-b border-slate-100 dark:border-slate-800 pb-2">
              <div className="flex items-center gap-1.5">
                <BookMarked className="w-4 h-4 text-[#0059bb] dark:text-sky-400" />
